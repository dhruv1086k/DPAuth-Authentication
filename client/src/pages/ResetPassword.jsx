                  ...
                  .map((_, index) => (
                    <div key={index} className="relative group">
                      <input
                        ...
                        className="w-14 h-14 bg-white/10 backdrop-blur-sm border-2 border-white/20 text-white text-center text-2xl font-bold rounded-2xl focus:outline-none focus:ring-2 focus:ring-rose-400 focus:border-rose-400 transition-all duration-300 hover:bg-white/20 group-hover:border-rose-300"
                      />
